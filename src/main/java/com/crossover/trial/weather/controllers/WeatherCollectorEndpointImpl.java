 ...
 */
@Path("/collect")
public final class WeatherCollectorEndpointImpl implements WeatherCollectorEndpoint {
    /**
    ...
    public Response getAirports() {
        return Response.status(Response.Status.OK)
            .entity(GSON.toJson(mWeatherService.getAirportData())).build();
    }

    @GET @Path("/airport/{iata}") @Override
